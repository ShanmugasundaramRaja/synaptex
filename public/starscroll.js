...
svg1TL.fromTo("#svg1", {width: () => {if(window.innerWidth < 600) {return 200} else {return 200}}}, {width: () => {if(window.innerWidth < window.innerHeight){return "100vh"} else {return "100vw"}}, ease: "none"}, 0);
...
svg2TL.fromTo("#svg2", {width: () => {if(window.innerWidth < 800) {return 200} else {return 300}}}, {width: () => {if(window.innerWidth < window.innerHeight){return "100vh"} else {return "100vw"}}, ease: "none"}, 0);
...
svg3TL.fromTo("#svg3", {width: () => {if(window.innerWidth < 800) {return 200} else {return 300}}}, {width: () => {if(window.innerWidth < window.innerHeight){return "100vh"} else {return "100vw"}}, ease: "none"}, 0);
...
svg4TL.fromTo("#svg4", {width: () => {if(window.innerWidth < 600) {return 200} else {return 200}}}, {width: () => {if(window.innerWidth < window.innerHeight){return "100vh"} else {return "100vw"}}, ease: "none"}, 0);
