window.onload = function () {
  ...
  loader.style.background = "#c3c2c2ff"; 
  ...
  // Wait 4 seconds, then initialize GSAP and hide loader
  setTimeout(() => {
    ...
    svg1TL.fromTo("#svg1", 
      ...
      {width: () => window.innerWidth < window.innerHeight ? "100vh" : "100vw", ease: "none"}, 0);
