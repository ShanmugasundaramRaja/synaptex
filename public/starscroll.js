window.onload = function () {
  ...
  svg1TL.fromTo(
    "#svg1",
    {
      width: () => window.innerWidth < 600 ? "70px" : "200px",
      height: () => window.innerWidth < 600 ? "70px" : "200px"
    },
    {
      width: () => window.innerWidth < window.innerHeight ? "100vh" : "100vw",
      height: () => window.innerWidth < window.innerHeight ? "100vh" : "100vw",
      ease: "none"
    },
    0
  );
